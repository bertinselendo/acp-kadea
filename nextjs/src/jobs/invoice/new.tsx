...
export const sendNewInvoiceNotification = async ({
  ...
  const heading = `New invoice - ${reference}`;
  const body = `A new invoice has been added to the project ${reference} by ${senderName}.`;
  const footer = "";
